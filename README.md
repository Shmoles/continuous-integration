# Continuous Integration ![https://github.com/Shmoles/continuous-integration/actions?query=workflow%3Atests](https://github.com/Shmoles/continuous-integration/workflows/tests/badge.svg)

*This is the first homework assignment for Claremont McKenna's [CSCI46: Data Structures](https://github.com/Shmoles/cmc-csci046) course and [CSCI143: Big Data](https://github.com/Shmoles/cmc-csci143) course.*
...
you need to modify the `README.md` so that the URL contains your username instead of `Shmoles`.
...
```
https://github.com/Shmoles/continuous-integration
```
